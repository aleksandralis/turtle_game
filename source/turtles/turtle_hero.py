...
class Turtle(pygame.sprite.Sprite):
    ...
    def __init__(self, type, size_coeff, name, position):
        ...
        self.name = name
        self.image = self.get_image(self.WIDTH * self.init_sub[0] , self.HEIGHT * self.init_sub[1], self.WIDTH, self.HEIGHT)#pygame.Surface([self.WIDTH * size_coeff, self.HEIGHT * size_coeff])
